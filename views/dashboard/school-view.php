...
<div class="row print">
    ...
    <div class="col-sm-2">
        <a class="btn btn-success pull-right mb hp" href="<?=site_url('school')?>"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Kembali</a>
        ...
        <?php if ($school['s_is_active'] == "Aktif") { ?>
            <?php if($school['s_status'] == "Lengkap") { ?>
            <?php } else if($school['s_status'] == "Kurang") { ?>
                <a href="<?=site_url('school/edit/'.$school['s_id'])?>" class="btn btn-primary pull-right mb hp"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Lengkapi Data</a>
            <?php } else { ?>
                <a href="<?=site_url('school/edit/'.$school['s_id'])?>" class="btn btn-primary pull-right mb hp"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Data</a>
            <?php } ?>
        <?php } ?>
    </div>
</div>
